...
const emptyFile_js_1 = require("./internal/emptyFile.js");
const filenameIdentify_js_1 = require("./filenameIdentify.js");
const filenameValidate_js_1 = require("./filenameValidate.js");
const applyRules_js_1 = require("../schema/applyRules.js");
const datasetIssues_js_1 = require("../issues/datasetIssues.js");
const summary_js_1 = require("../summary/summary.js");
const loadSchema_js_1 = require("../setup/loadSchema.js");
const context_js_1 = require("../schema/context.js");
const walk_js_1 = require("../schema/walk.js");
/** Array of validation check functions to be applied to each file */
const CHECKS = [
    emptyFile_js_1.emptyFile,
    filenameIdentify_js_1.filenameIdentify,
    filenameValidate_js_1.filenameValidate,
    applyRules_js_1.applyRules,
];
/**
...
async function validate(fileTree, options) {
    ...
    const summary = new summary_js_1.Summary();
    const schema = await (0, loadSchema_js_1.loadSchema)(options.schema);
    const issues = new datasetIssues_js_1.DatasetIssues(schema);
    ...
    const ddFile = fileTree.files.find((file) => file.path === "/dataset_description.json");
    let dsContext;
    if (ddFile) {
        ...
        try {
            const description = await ddFile.text()
                .then(JSON.parse);
            dsContext = new context_js_1.psychDSContextDataset(options, ddFile, description);
        }
        catch (_error) {
            // Handle invalid JSON formatting in metadata
            dsContext = new context_js_1.psychDSContextDataset(options, ddFile);
        ...
        dsContext = new context_js_1.psychDSContextDataset(options);
    }
    // Track which schema rules are satisfied by files in the dataset
    const rulesRecord = {};
    (0, filenameIdentify_js_1.findFileRules)(schema, rulesRecord);
    ...
    for await (const context of (0, walk_js_1.walkFileTree)(fileTree, issues, dsContext)) {
    ...
    (0, filenameIdentify_js_1.checkDirRules)(schema, rulesRecord, dsContext.baseDirs);
    (0, filenameValidate_js_1.checkMissingRules)(schema, rulesRecord, issues);
