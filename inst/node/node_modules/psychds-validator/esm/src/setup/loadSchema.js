...
import { isBrowser, isDeno, isNode, path, readFile, } from "../utils/platform.js";
/** Base URL for fetching version-specific schema files */
const SCHEMA_BASE_URL = "https://raw.githubusercontent.com/psych-ds/psych-DS/master/schema_model/versions/jsons";
/** URL for fetching the Schema.org definitions */
const SCHEMA_ORG_URL = "https://raw.githubusercontent.com/psych-ds/psych-DS/master/schema_model/external_schemas/schemaorg/schemaorg.json";
let cachedSchema = null;
/** Default schema storage for fallback scenarios */
let defaultSchema = {};
let defaultSchemaOrg = {};
/**
...
export async function loadSchema(version = "latest") {
    if (cachedSchema && cachedSchema.version === version) {
        return new Proxy(cachedSchema.schema, objectPathHandler); // Fixed!
    }
    // Ensure default schemas are loaded
    if (Object.keys(defaultSchema).length === 0 ||
