...
import { isBrowser, readFile } from "../utils/platform.js";
import { fetchJSON } from "../setup/loadSchema.js";
/**
...
export class psychDSContext {
    ...
    async getExpandedSidecar() {
        ...
        // deno-lint-ignore no-explicit-any
        const jsonldToUse = isBrowser ? dntShim.dntGlobalThis.jsonld : jsonld;
