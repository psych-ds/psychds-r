...
export class ValidationProgressTracker {
    ...
    displayChecklist() {
        ...
        this.steps.forEach((superStep, index) => {
            ...
            const superStepMessage = this.getStepMessage(superStep, isStepCompleteAndValid);
            ...
            if (isStepCompleteAndValid && superStepStatus &&
            ...
            superStep.subSteps.forEach((subStep, subIndex) => {
                ...
                if (isSubStepCompleteAndValid && subStepStatus &&
