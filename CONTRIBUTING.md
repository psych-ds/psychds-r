...
If you find a bug, please [open an issue](https://github.com/psych-ds/psychds-r/issues/new) with:
...
Feature requests are welcome! Please [open an issue](https://github.com/psych-ds/psychds-r/issues/new) with:

1. A clear description of the feature
2. Why it would be useful
3. Any examples or mockups (if applicable)

- Read the [package documentation](https://psych-ds.github.io/psychds-r/)
- Check existing [issues](https://github.com/psych-ds/psychds-r/issues)
- Ask questions in [discussions](https://github.com/psych-ds/psychds-r/discussions)
